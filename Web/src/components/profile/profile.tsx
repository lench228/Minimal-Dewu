...
export const Profile = () => {
  ...
  return (
    <div
      className={
        "overflow-y-scroll mt-10 mb-12 sm:mb-0 font-main  text-white-darker-1 flex sm:flex-row flex-col sm:items-center sm:justify-center  sm:m-auto"
      }
    >
      <section
        className={
          "sm:h-full p-4 h-[200px] flex flex-col gap-2  border-black-light-2 self-start  sm:m-2 s,w-2/6 border-[1px] rounded-xl bg-black-light"
        }
      >
        <div className={"flex border-b-[1px] justify-between "}>
          <h1 className={"flex flex-col font-bold text-3xl pb-2 "}>
            Привет, <br />
            <span className={"pl-4"}>
              {userName ? userName : "Ошибка при загрузке имени"}
            </span>
          </h1>
          <Button
